...
namespace MasterDevs.ChromeDevTools.Protocol.iOS.Timeline
{
	...
	{
		/// <summary>
		/// Gets or setsTotal number of calls.

		/// </summary>
		public double CallCount { get; set; }
		/// <summary>
		/// Gets or setsStart time for the first call.

		/// </summary>
		public double StartTime { get; set; }
		/// <summary>
		/// Gets or setsEnd time for the last call.

		/// </summary>
		public double EndTime { get; set; }
		/// <summary>
		/// Gets or setsTotal execution time for all calls combined.
