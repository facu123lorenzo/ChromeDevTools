...
namespace MasterDevs.ChromeDevTools.Protocol.iOS.Runtime
{
	...
	public class GetPropertiesCommand: ICommand<GetPropertiesCommandResponse>
	{
		...
		/// <summary>
		/// Gets or setsIf true, returns properties belonging only to the object itself, not to its prototype chain.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? OwnProperties { get; set; }
		/// <summary>
		/// Gets or setsWhether preview should be generated for property values.
