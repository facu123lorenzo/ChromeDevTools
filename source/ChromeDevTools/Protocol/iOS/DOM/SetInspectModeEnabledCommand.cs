...
namespace MasterDevs.ChromeDevTools.Protocol.iOS.DOM
{
	...
	{
		/// <summary>
		/// Gets or setsTrue to enable inspection mode, false to disable it.

		/// </summary>
		public bool Enabled { get; set; }
		/// <summary>
		/// Gets or setsA descriptor for the highlight appearance of hovered-over nodes. May be omitted if <code>enabled == false</code>.
