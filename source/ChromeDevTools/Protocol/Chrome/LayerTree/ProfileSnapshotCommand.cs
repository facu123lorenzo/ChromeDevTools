...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.LayerTree
{
	...
	public class ProfileSnapshotCommand: ICommand<ProfileSnapshotCommandResponse>
	{
		...
		/// <summary>
		/// Gets or setsThe maximum number of times to replay the snapshot (1, if not specified).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long? MinRepeatCount { get; set; }
		/// <summary>
		/// Gets or setsThe minimum duration (in seconds) to replay the snapshot.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public double MinDuration { get; set; }
		/// <summary>
		/// Gets or setsThe clip rectangle to apply when replaying the snapshot.
