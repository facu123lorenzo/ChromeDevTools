...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.LayerTree
{
	...
	{
		/// <summary>
		/// Gets or setsA list of strings specifying reasons for the given layer to become composited.

		/// </summary>
		public string[] CompositingReasons { get; set; }
		/// <summary>
		/// Gets or setsA list of strings specifying reason IDs for the given layer to become composited.
