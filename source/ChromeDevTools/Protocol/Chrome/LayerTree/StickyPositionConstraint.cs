...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.LayerTree
{
	...
	{
		/// <summary>
		/// Gets or setsLayout rectangle of the sticky element before being shifted

		/// </summary>
		public DOM.Rect StickyBoxRect { get; set; }
		/// <summary>
		/// Gets or setsLayout rectangle of the containing block of the sticky element

		/// </summary>
		public DOM.Rect ContainingBlockRect { get; set; }
		/// <summary>
		/// Gets or setsThe nearest sticky layer that shifts the sticky box

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public string NearestLayerShiftingStickyBox { get; set; }
		/// <summary>
		/// Gets or setsThe nearest sticky layer that shifts the containing block
