...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMSnapshot
{
	...
	public class GetSnapshotCommand: ICommand<GetSnapshotCommandResponse>
	{
		...
		/// <summary>
		/// Gets or setsWhether or not to retrieve details of DOM listeners (default false).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? IncludeEventListeners { get; set; }
		/// <summary>
		/// Gets or setsWhether to determine and include the paint order index of LayoutTreeNodes (default false).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? IncludePaintOrder { get; set; }
		/// <summary>
		/// Gets or setsWhether to include UA shadow tree in the snapshot (default false).
