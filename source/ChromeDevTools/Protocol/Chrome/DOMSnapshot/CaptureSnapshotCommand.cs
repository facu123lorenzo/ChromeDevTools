...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMSnapshot
{
	...
	{
		/// <summary>
		/// Gets or setsWhitelist of computed styles to return.

		/// </summary>
		public string[] ComputedStyles { get; set; }
		/// <summary>
		/// Gets or setsWhether to include layout object paint orders into the snapshot.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? IncludePaintOrder { get; set; }
		/// <summary>
		/// Gets or setsWhether to include DOM rectangles (offsetRects, clientRects, scrollRects) into the snapshot

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? IncludeDOMRects { get; set; }
		/// <summary>
		/// Gets or setsWhether to include blended background colors in the snapshot (default: false).
		...
		/// <summary>
		/// Gets or setsWhether to include text color opacity in the snapshot (default: false).
