...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMSnapshot
{
	...
	{
		/// <summary>
		/// Gets or setsThe nodes in the DOM tree. The DOMNode at index 0 corresponds to the root document.
		...
		/// <summary>
		/// Gets or setsWhitelisted ComputedStyle properties for each node in the layout tree.
