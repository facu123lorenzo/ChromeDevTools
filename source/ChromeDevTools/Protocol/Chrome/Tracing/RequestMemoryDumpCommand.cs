...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Tracing
{
	...
	{
		/// <summary>
		/// Gets or setsEnables more deterministic results by forcing garbage collection

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? Deterministic { get; set; }
		/// <summary>
		/// Gets or setsSpecifies level of details in memory dump. Defaults to "detailed".
