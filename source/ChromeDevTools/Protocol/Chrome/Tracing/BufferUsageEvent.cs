...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Tracing
{
	...
	{
		/// <summary>
		/// Gets or setsA number in range [0..1] that indicates the used size of event buffer as a fraction of its
		/// total size.
		...
		/// <summary>
		/// Gets or setsAn approximate number of events in the trace log.
