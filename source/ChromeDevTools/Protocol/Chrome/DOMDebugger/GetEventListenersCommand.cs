...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMDebugger
{
	...
	{
		/// <summary>
		/// Gets or setsIdentifier of the object to return listeners for.

		/// </summary>
		public string ObjectId { get; set; }
		/// <summary>
		/// Gets or setsThe maximum depth at which Node children should be retrieved, defaults to 1. Use -1 for the
