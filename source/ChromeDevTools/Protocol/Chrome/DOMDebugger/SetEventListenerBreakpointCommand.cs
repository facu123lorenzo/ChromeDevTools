...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMDebugger
{
	...
	{
		/// <summary>
		/// Gets or setsDOM Event name to stop on (any DOM event will do).

		/// </summary>
		public string EventName { get; set; }
		/// <summary>
		/// Gets or setsEventTarget interface name to stop on. If equal to `"*"` or not provided, will stop on any
		/// EventTarget.
