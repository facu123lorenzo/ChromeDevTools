...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class EvaluateCommand: ICommand<EvaluateCommandResponse>
	{
		...
		/// <summary>
		/// Gets or setsDetermines whether Command Line API should be available during the evaluation.
		...
		/// <summary>
		/// Gets or setsSpecifies in which execution context to perform evaluation. If the parameter is omitted the
		...
		/// <summary>
		/// Gets or setsDisable breakpoints during execution.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? DisableBreaks { get; set; }
		/// <summary>
		/// Gets or setsSetting this flag to true enables `let` re-declaration and top-level `await`.
		...
		/// <summary>
		/// Gets or setsThe Content Security Policy (CSP) for the target might block 'unsafe-eval'
		...
		/// <summary>
		/// Gets or setsAn alternative way to specify the execution context to evaluate in.
