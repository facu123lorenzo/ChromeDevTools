...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome
{
	public static class ProtocolName
	{
		...
		public static class Audits
		{
			...
			public const string CheckFormsIssues = "Audits.checkFormsIssues";
			public const string IssueAdded = "Audits.issueAdded";
		}

		public static class Autofill
		{
			public const string Trigger = "Autofill.trigger";
			public const string SetAddresses = "Autofill.setAddresses";
			public const string Disable = "Autofill.disable";
			public const string Enable = "Autofill.enable";
			public const string AddressFormFilled = "Autofill.addressFormFilled";
		}
		...
		public static class Browser
		{
			...
			public const string AddPrivacySandboxEnrollmentOverride = "Browser.addPrivacySandboxEnrollmentOverride";
		...
		public static class CSS
		{
			...
			public const string SetPropertyRulePropertyName = "CSS.setPropertyRulePropertyName";
		...
		public static class EventBreakpoints
		{
			...
			public const string Disable = "EventBreakpoints.disable";
		}
		...
		public static class Emulation
		{
			...
			public const string GetOverriddenSensorInformation = "Emulation.getOverriddenSensorInformation";
			public const string SetSensorOverrideEnabled = "Emulation.setSensorOverrideEnabled";
			public const string SetSensorOverrideReadings = "Emulation.setSensorOverrideReadings";
		...
		public static class Input
		{
			...
			public const string CancelDragging = "Input.cancelDragging";
		...
		public static class Network
		{
			...
			public const string StreamResourceContent = "Network.streamResourceContent";
		...
		public static class Overlay
		{
			...
			public const string SetShowWindowControlsOverlay = "Overlay.setShowWindowControlsOverlay";
		...
		public static class Page
		{
			...
			public const string SetPrerenderingAllowed = "Page.setPrerenderingAllowed";
		...
		public static class Storage
		{
			...
			public const string SetStorageBucketTracking = "Storage.setStorageBucketTracking";
			public const string DeleteStorageBucket = "Storage.deleteStorageBucket";
			public const string RunBounceTrackingMitigations = "Storage.runBounceTrackingMitigations";
			public const string SetAttributionReportingLocalTestingMode = "Storage.setAttributionReportingLocalTestingMode";
			public const string SetAttributionReportingTracking = "Storage.setAttributionReportingTracking";
			...
			public const string StorageBucketCreatedOrUpdated = "Storage.storageBucketCreatedOrUpdated";
			public const string StorageBucketDeleted = "Storage.storageBucketDeleted";
			public const string AttributionReportingSourceRegistered = "Storage.attributionReportingSourceRegistered";
			public const string AttributionReportingTriggerRegistered = "Storage.attributionReportingTriggerRegistered";
		}
		...
		public static class Preload
		{
			...
			public const string PreloadEnabledStateUpdated = "Preload.preloadEnabledStateUpdated";
		...
		public static class FedCm
		{
			...
			public const string ClickDialogButton = "FedCm.clickDialogButton";
			public const string DismissDialog = "FedCm.dismissDialog";
			public const string ResetCooldown = "FedCm.resetCooldown";
			public const string DialogShown = "FedCm.dialogShown";
			public const string DialogClosed = "FedCm.dialogClosed";
		}
