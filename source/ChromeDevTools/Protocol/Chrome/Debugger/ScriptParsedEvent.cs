...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Debugger
{
	...
	public class ScriptParsedEvent
	{
		...
		/// <summary>
		/// Gets or setsTrue, if this script is generated as a result of the live edit operation.
		...
		/// <summary>
		/// Gets or setsIf the scriptLanguage is WebASsembly, the source of debug symbols for the module.
