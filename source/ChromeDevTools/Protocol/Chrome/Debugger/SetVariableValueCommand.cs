...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Debugger
{
	...
	{
		/// <summary>
		/// Gets or sets0-based number of scope as was listed in scope chain. Only 'local', 'closure' and 'catch'
		/// scope types are allowed. Other scopes could be manipulated manually.

		/// </summary>
		public long ScopeNumber { get; set; }
		/// <summary>
		/// Gets or setsVariable name.

		/// </summary>
		public string VariableName { get; set; }
		/// <summary>
		/// Gets or setsNew variable value.

		/// </summary>
		public Runtime.CallArgument NewValue { get; set; }
		/// <summary>
		/// Gets or setsId of callframe that holds variable.
