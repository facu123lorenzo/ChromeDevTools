...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Fetch
{
	...
	public class ContinueResponseCommand: ICommand<ContinueResponseCommandResponse>
	{
		...
		/// <summary>
		/// Gets or setsAn HTTP response code. If absent, original response code will be used.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long? ResponseCode { get; set; }
		/// <summary>
		/// Gets or setsA textual representation of responseCode.
		...
		/// <summary>
		/// Gets or setsResponse headers. If absent, original response headers will be used.

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public HeaderEntry[] ResponseHeaders { get; set; }
		/// <summary>
		/// Gets or setsAlternative way of specifying response headers as a \0-separated
