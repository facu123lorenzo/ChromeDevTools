...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Fetch
{
	...
	{
		/// <summary>
		/// Gets or setsIf specified, only requests matching any of these patterns will produce
		...
		/// <summary>
		/// Gets or setsIf true, authRequired events will be issued and requests will be paused
