...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Input
{
	...
	public class TouchPoint
	{
		...
		/// <summary>
		/// Gets or setsX radius of the touch area (default: 1.0).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public double RadiusX { get; set; }
		/// <summary>
		/// Gets or setsY radius of the touch area (default: 1.0).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public double RadiusY { get; set; }
		/// <summary>
		/// Gets or setsRotation angle (default: 0.0).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public double RotationAngle { get; set; }
		/// <summary>
		/// Gets or setsForce (default: 1.0).
		...
		/// <summary>
		/// Gets or setsIdentifier used to track touch sources between events, must be unique within an event.
