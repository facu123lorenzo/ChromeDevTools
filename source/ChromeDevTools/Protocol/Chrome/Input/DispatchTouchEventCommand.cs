...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Input
{
	...
	{
		/// <summary>
		/// Gets or setsType of the touch event. TouchEnd and TouchCancel must not contain any touch points, while
		/// TouchStart and TouchMove must contains at least one.

		/// </summary>
		public string Type { get; set; }
		/// <summary>
		/// Gets or setsActive touch points on the touch device. One event per any changed point (compared to
