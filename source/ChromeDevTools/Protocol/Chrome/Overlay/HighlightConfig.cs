...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Overlay
{
	...
	public class HighlightConfig
	{
		...
		/// <summary>
		/// Gets or setsWhether the node styles in the tooltip (default: false).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? ShowStyles { get; set; }
		/// <summary>
		/// Gets or setsWhether the rulers should be shown (default: false).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? ShowRulers { get; set; }
		/// <summary>
		/// Gets or setsWhether the a11y info should be shown (default: true).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? ShowAccessibilityInfo { get; set; }
		/// <summary>
		/// Gets or setsWhether the extension lines from node to the rulers should be shown (default: false).
		...
		/// <summary>
		/// Gets or setsThe event target element highlight fill color (default: transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public DOM.RGBA EventTargetColor { get; set; }
		/// <summary>
		/// Gets or setsThe shape outside fill color (default: transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public DOM.RGBA ShapeColor { get; set; }
		/// <summary>
		/// Gets or setsThe shape margin fill color (default: transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public DOM.RGBA ShapeMarginColor { get; set; }
		/// <summary>
		/// Gets or setsThe grid layout color (default: transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public DOM.RGBA CssGridColor { get; set; }
		/// <summary>
		/// Gets or setsThe color format used to format color styles (default: hex).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public ColorFormat ColorFormat { get; set; }
		/// <summary>
		/// Gets or setsThe grid layout highlight configuration (default: all transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public GridHighlightConfig GridHighlightConfig { get; set; }
		/// <summary>
		/// Gets or setsThe flex container highlight configuration (default: all transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public FlexContainerHighlightConfig FlexContainerHighlightConfig { get; set; }
		/// <summary>
		/// Gets or setsThe flex item highlight configuration (default: all transparent).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public FlexItemHighlightConfig FlexItemHighlightConfig { get; set; }
		/// <summary>
		/// Gets or setsThe contrast algorithm to use for the contrast ratio (default: aa).

		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public ContrastAlgorithm ContrastAlgorithm { get; set; }
		/// <summary>
		/// Gets or setsThe container query container highlight configuration (default: all transparent).
